...
function formarHistorico(){
    ...
    db.transaction(function(tx){
        tx.executeSql("SELECT * FROM (SELECT nome, valor, data FROM despesa UNION ALL SELECT nome, valor, data FROM receita) GROUP BY data ORDER BY data ",[],function(tx,results){
            var i;
            var conteudo;
