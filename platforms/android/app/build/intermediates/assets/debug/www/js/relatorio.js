...
function grafico(data,tipo,etiqueta){
    ...
    db.transaction(function(tx){
        tx.executeSql("SELECT * FROM (SELECT nome, valor, etiquetaID, data FROM despesa UNION ALL SELECT nome, valor, etiquetaID, data FROM receita) WHERE data>=? GROUP BY data ORDER BY data ",[data],function(tx,results){
